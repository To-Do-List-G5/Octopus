      ...
      <div className="flex h-screen flex-col justify-between pt-2 pb-6">
        <div>
          ...
          <ul className="mt-6 space-y-2 tracking-wide">
            ...
            <li className="min-w-max">
              <Link  to="/contact" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
            
                <i className='bx bx-support h-5 w-5  text-2xl text-black' ></i>
                <span className="group-hover:text-gray-700">Contact Us</span>
              </Link>
            </li>
            <li className="min-w-max">
              <Link  to="/about" href="#" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
        ...
        <div className="w-max -mb-3">
          <Link to="/login" className="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 ">
            ...
            <span className="group-hover:text-gray-700 text-center mt-2 text-2xl">Login</span>
          </Link>
        </div>  
      </div>
    </div>
