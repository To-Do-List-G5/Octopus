...
export default function Login() {
  ...
  //   ) {
  //     errors.email = "Invalid email address. Missing domain part after @";
  //   } else if (!/@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(values.email)) {
  //     errors.email =
  //       "Invalid email address. Missing top-level domain (e.g., .com, .net)";
  //   }
          ...
          <div className="w-full">
            <div className="block rounded-lg bg-white shadow-lg ">
              <div className="g-0 lg:flex lg:flex-wrap">
                ...
                <div className="flex items-center rounded-b-lg bg-gradient-to-r from-sky-600 to-cyan-400 lg:w-6/12 lg:rounded-r-lg lg:rounded-bl-none">
                  <div className="px-4 py-6 text-white md:mx-6 md:p-12">
                    <h4 className="mb-6 text-xl font-semibold">
                      Welcome to octopus
                    </h4>
                    <p className="text-sm">
                      Welcome to OctoList, your ultimate guide to organizing
                      your octopus-themed tasks! Dive into a world
                    </p>
                  </div>
                </div>
              </div>
